...
Shader "SLZ/Video DOF Dither"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform UNITY_DECLARE_TEX2DARRAY( _SLZ_DitherTex2D );
			...
			fixed4 frag (v2f i , bool bIsFrontFace : SV_IsFrontFace) : SV_Target
			{
				...
				float2 uv0_EmissionMap = i.ase_texcoord1.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
				float4 unityObjectToClipPos23_g23 = UnityObjectToClipPos( i.ase_texcoord2.xyz );
				float4 computeScreenPos18_g23 = ComputeScreenPos( unityObjectToClipPos23_g23 );
				float4 texArray3_g23 = UNITY_SAMPLE_TEX2DARRAY(_SLZ_DitherTex2D, float3(( ( computeScreenPos18_g23 / (computeScreenPos18_g23).z ) / float4( ( (_ScreenParams).xy / 64 ), 0.0 , 0.0 ) ).xy, (float)_SLZ_TexSel)  );
			...
			//	float3 vNormalTs = float3( 0.0, 0.0, 1.0 );		
				...
				float3 Albedo = fixed3(1,1,1);
				float3 Normal = fixed3(0,0,1);  //vNormalTs
				float3 Emission = tex2D( _EmissionMap, ( float4( uv0_EmissionMap, 0.0 , 0.0 ) + ( ( texArray3_g23 - temp_cast_5 ) * ( _Blur * saturate( (0.0 + (distance( i.vPositionWs.xyz , _WorldSpaceCameraPos ) - _NearDistance) * (1.0 - 0.0) / (_FarDistance - _NearDistance)) ) ) ) ).rg ).rgb;
...
/*ASEBEGIN
Version=16900
1431;894;1673;775;1001.94;206.7829;1.3;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;34;-835.8752,332.6605;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceCameraPos;35;-888.8752,488.6605;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DistanceOpNode;36;-561.8752,342.6605;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-407.9131,489.019;Float;False;Property;_NearDistance;Near Distance;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-396.4316,564.2863;Float;False;Property;_FarDistance;Far Distance;5;0;Create;True;0;0;False;0;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;37;-134.3538,474.6875;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-597.4908,62.72484;Float;False;Property;_Blur;Blur;6;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-611.3707,-203.0637;Float;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;40;-254.3391,144.1118;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;42;-726.4153,-294.811;Float;False;Bluenoise Sample;1;;23;5cf51994b7c006949a29f871e7dfff77;0;1;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;30;-409.3708,-240.0637;Float;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-123.2017,35.50323;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-269.3709,-172.0637;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-533.7915,-74.07061;Float;False;0;3;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;33;-39.37099,-89.06375;Float;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-36.03961,193.6171;Float;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;False;0;20;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;135.1967,-106.8793;Float;True;Property;_EmissionMap;_EmissionMap;0;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;528.8588,-81.18849;Float;False;True;2;Float;ASEMaterialInspector;0;11;SLZ/Video DOF Dither;1f6ac94e27bd0934ab97faa6217ad58e;True;VRBase;0;0;VRBase;15;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;False;0;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;True;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;2;LightMode=ForwardBase;PassFlags=OnlyDirectional;True;2;0;;0;0;Standard;0;0;1;True;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT3;0,0,0;False;13;FLOAT4;0,0,0,0;False;14;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=4D8DEC091A0AF1EA750317372DDE576F8AE04AB7