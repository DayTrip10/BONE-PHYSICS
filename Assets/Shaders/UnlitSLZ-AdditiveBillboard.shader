Shader "Unlit/SLZ-AdditiveBillboard" {
	...
	SubShader {
		...
		Pass {
			Name "FORWARD"
			Tags { "IsEmissive" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent+0" "RenderType" = "Custom" "SHADOWSUPPORT" = "true" }
		...
		Pass {
			Name "ShadowCaster"
			Tags { "IsEmissive" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Transparent+0" "RenderType" = "Custom" "SHADOWSUPPORT" = "true" }
			Blend One One, One One
			GpuProgramID 108173
			Program "vp" {
				SubProgram "d3d11 " {
