Shader "SLZ/Icon Billboard" {
	Properties {
		...
		[HDR] _Color ("Color", Vector) = (8,8,8,1)
		[PerRendererData] _MainTex ("MainTex", 2DArray) = "" {}
		[PerRendererData] _IconSelection ("IconSelection", Float) = 0
		[PerRendererData] _IconSize ("IconSize", Float) = 0.1
		[HideInInspector] _texcoord ("", 2D) = "white" {}
		[HideInInspector] __dirty ("", Float) = 1
	}
	SubShader {
		Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "IsEmissive" = "true" "QUEUE" = "Overlay+0" "RenderType" = "TransparentCutout" }
		Pass {
			Name "FORWARD"
			Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "IsEmissive" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Overlay+0" "RenderType" = "TransparentCutout" }
