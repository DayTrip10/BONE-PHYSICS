...
Shader "SLZ/Holographic Killer"
{
	Properties
	{
		...
		_Vector0("Vector 0", Vector) = (0,1.7,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i , bool bIsFrontFace : SV_IsFrontFace) : SV_Target
			{
				...
				float2 uv_BumpMap = i.ase_texcoord1.xyz * _BumpMap_ST.xy + _BumpMap_ST.zw;
				...
				float3 break77 = ( (  ( -ase_worldViewDir - 0.0 > 0.0 ? ( _Boxscale + _Pos ) : -ase_worldViewDir - 0.0 <= 0.0 && -ase_worldViewDir + 0.0 >= 0.0 ? 0.0 : ( -_Boxscale + _Pos2 ) )  - ( ( i.vPositionWs.xyz - _Vector0 ) - objToWorld126 ) ) / -ase_worldViewDir );
			...
			//	float3 vNormalTs = float3( 0.0, 0.0, 1.0 );		
				...
				float3 Emission = ( ( texCUBElod( _CubeBG, float4( ( ( -ase_worldViewDir * min( min( break77.x , break77.y ) , break77.z ) ) + ( ( ( i.vPositionWs.xyz - _Vector0 ) - objToWorld126 ) - _Pos ) ), ( ( 1.0 - dotResult20 ) * _FresnelBlur )) ) * _ScreenColor ) * tex2D( _EmissionMask, uv_EmissionMask ) ).rgb;
...
/*ASEBEGIN
Version=16900
2019;1985;1524;1047;4055.06;-40.73392;1;True;True
...
Node;AmplifyShaderEditor.Vector3Node;73;-3118.625,773.5765;Float;False;Property;_Boxscale;Box scale;14;0;Create;True;0;0;False;0;0,0,0;5,3.3,5;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;130;-3649.06,450.7339;Float;False;Property;_Vector0;Vector 0;15;0;Create;True;0;0;False;0;0,1.7,0;0,1.7,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;71;-3647.578,249.8884;Float;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;72;-3073.384,1062.442;Float;False;Property;_Pos;Pos;12;0;Create;True;0;0;False;0;0,0,0;0,-1.28,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TransformPositionNode;126;-3528.31,635.8633;Float;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleSubtractOpNode;131;-3276.06,354.7339;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,1.7,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;178.7686,96.86987;Float;False;Property;_Smoothness;Smoothness;8;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;172.4456,24.64542;Float;False;Property;_Metallic;Metallic;9;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;9;-147.0273,-476.3199;Float;False;Property;_Color;Color;2;0;Create;True;0;0;False;0;0,0,0,0;0.03270737,0.1415094,0.03270737,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=3D5761336EA9C8F719C722A2E62E550B6B2CB4A3