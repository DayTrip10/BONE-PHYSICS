Shader "SLZ/Baked Vertex Lighting" {
	Properties {
		...
		[HDR] _VertexEmissionColor ("Vertex Emission Color", Vector) = (0,0,0,0)
	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					Keywords { "_EMISSION" "_DETAIL_MULX2" "_METALLICGLOSSMAP" }
					"vs_4_0
					/*Can't export program data d3d11 as a text*/"
				}
				SubProgram "d3d11 " {
					Keywords { "_EMISSION" "STEREO_CUBEMAP_RENDER_ON" "_DETAIL_MULX2" "_METALLICGLOSSMAP" }
					"vs_4_0
					/*Can't export program data d3d11 as a text*/"
				}
				SubProgram "d3d11 " {
					Keywords { "_EMISSION" "STEREO_INSTANCING_ON" "_DETAIL_MULX2" "_METALLICGLOSSMAP" }
					"vs_4_0
					/*Can't export program data d3d11 as a text*/"
				}
				SubProgram "d3d11 " {
					Keywords { "_EMISSION" "STEREO_INSTANCING_ON" "STEREO_CUBEMAP_RENDER_ON" "_DETAIL_MULX2" "_METALLICGLOSSMAP" }
					"vs_4_0
					/*Can't export program data d3d11 as a text*/"
				}
			}
