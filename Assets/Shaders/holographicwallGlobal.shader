...
Shader "SLZ/Holographic Wall Global"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform float globalScreenScaler;
			...
			//	float3 vNormalTs = float3( 0.0, 0.0, 1.0 );		
				...
				float3 Emission = ( ( texCUBElod( _CubeBG, float4( ( ( -ase_worldViewDir * min( min( break77.x , break77.y ) , break77.z ) ) + ( i.vPositionWs.xyz - _Pos ) ), ( ( 1.0 - dotResult20 ) * _FresnelBlur )) ) * _ScreenColor * dotResult20 ) * tex2D( _EmissionMask, uv_EmissionMask ) * globalScreenScaler ).rgb;
...
/*ASEBEGIN
Version=15800
1989;2097;1524;994;701.8239;388.5814;1;True;True
...
Node;AmplifyShaderEditor.Vector3Node;72;-3073.384,1062.442;Float;False;Property;_Pos;Pos;12;0;Create;True;0;0;False;0;0,0,0;0,5,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;104;-3070.449,1255.855;Float;False;Property;_Pos2;Pos2;13;0;Create;True;0;0;False;0;0,0,0;0,200.3,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;4;-876.7577,241.4463;Float;True;Property;_CubeBG;CubeBG;1;0;Create;True;0;0;False;0;None;caf948dfb5d85b041a452b1d547f9879;True;0;False;black;LockedToCube;False;Object;-1;MipLevel;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-563.9006,356.8009;Float;False;Property;_ScreenColor;ScreenColor;3;1;[HDR];Create;True;0;0;False;0;1,1,1,1;4,4,4,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;9;-147.0273,-476.3199;Float;False;Property;_Color;Color;2;0;Create;True;0;0;False;0;0,0,0,0;0.08348162,0.2641509,0.2616063,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;227.1576,240.4339;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;1.7686,107.8699;Float;False;Property;_Smoothness;Smoothness;8;0;Create;True;0;0;False;0;0;0.679;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;111;-12.5544,23.64542;Float;False;Property;_Metallic;Metallic;9;0;Create;True;0;0;False;0;0;0.764;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=357AD0087AAE899AE2178515AF40CED81D3D84A5