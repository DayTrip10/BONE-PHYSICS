	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i , bool bIsFrontFace : SV_IsFrontFace) : SV_Target
			{
				...
				float4 temp_output_16_0 = ( tex2D( _MainTex, uv0_MainTex ) * _Color );
				#ifdef _VERTEXTINT_ON
				float4 staticSwitch7 = ( temp_output_16_0 * i.ase_color );
				#else
				float4 staticSwitch7 = temp_output_16_0;
				#endif
				float2 uv_DetailAlbedoMap = i.ase_texcoord1.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				
				float3 temp_output_16_2 = UnpackScaleNormal( tex2D( _BumpMap, uv0_MainTex ), _BumpScale );
				float2 uv0_DetailAlbedoMap = i.ase_texcoord1.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				
				float4 break4 = tex2D( _MetallicGlossMap, uv0_MainTex );
				float3 temp_cast_3 = (break4.r).xxx;
				
				float3 temp_output_1_0_g3 = temp_output_16_2;
				float2 temp_output_5_0_g3 = (temp_output_1_0_g3).xy;
				float2 temp_output_2_0_g3 = abs( ( temp_output_5_0_g3 * temp_output_5_0_g3 ) );
				float lerpResult11 = lerp( 1.0 , ( ( 1.0 - ( (temp_output_2_0_g3).x + (temp_output_2_0_g3).y ) ) * (temp_output_1_0_g3).z ) , _NormalToOcclusion);
				#ifdef _VERTEXAO_ON
				float staticSwitch6 = ( break4.g * i.ase_color.r );
				#else
				float staticSwitch6 = break4.g;
				#endif
				float temp_output_13_0 = ( lerpResult11 * staticSwitch6 );
			...
			//	float3 vNormalTs = float3( 0.0, 0.0, 1.0 );		
				...
				float3 Albedo = ( staticSwitch7 * ( tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) * unity_ColorSpaceDouble ) ).xyz;
				float3 Normal = BlendNormals( temp_output_16_2 , UnpackScaleNormal( tex2D( _DetailNormalMap, uv0_DetailAlbedoMap ), _DetailNormalMapScale ) );  //vNormalTs
				float3 Emission = fixed3(0,0,0);
				float Metallic = temp_cast_3;
				float Roughness = 1 - saturate( break4.b );
				float Retroreflective = 0;
				float AnisotropicDirection = 0;
				float AnisotropicRatio = 1;
				float DiffuseOcclusion = temp_output_13_0;
				float SpecularOcclusion = temp_output_13_0;
				float Alpha = 1;
				float Cutoff = 1;
...
/*ASEBEGIN
Version=16900
2097;1933;1417;1036;1431.845;601.2701;1.3;True;True
Node;AmplifyShaderEditor.FunctionNode;16;-1004.4,-53.3;Float;False;Standard Inputs;2;;6;c903fe98023011546b9734e2ef047384;0;0;4;COLOR;0;COLOR;1;FLOAT3;2;COLOR;3
Node;AmplifyShaderEditor.VertexColorNode;5;-949.5,-428.5;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;4;-910.2997,170.5;Float;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-464.3256,401.4562;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;10;-402.7238,105.5005;Float;False;Normal to AO;-1;;3;8de3130483a168e45ac6c4f4fe4e486d;0;1;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-474.1045,197.7495;Float;False;Property;_NormalToOcclusion;_NormalToOcclusion;8;0;Create;True;0;0;False;0;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-587.0999,-136;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;6;-290.5,373.5;Float;False;Property;_VertexAO;Vertex AO;0;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;11;-71.45036,182.6647;Float;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;7;-407.1,-169;Float;False;Property;_VertexTint;Vertex Tint;1;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;27.38567,353.3961;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;14;-138.8044,-100.6395;Float;False;Detail Maps;9;;4;7f7bf8e1d76e0dc4fb049018978c12cf;0;2;8;FLOAT4;0,0,0,0;False;9;FLOAT3;0,0,0;False;2;FLOAT4;0;FLOAT3;7
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;243,-57;Float;False;True;2;Float;ASEMaterialInspector;0;11;SLZ/Vertex Tinting;1f6ac94e27bd0934ab97faa6217ad58e;True;VRBase;0;0;VRBase;15;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;False;0;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;True;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;2;LightMode=ForwardBase;PassFlags=OnlyDirectional;True;2;0;;0;0;Standard;0;0;1;True;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT3;0,0,0;False;13;FLOAT4;0,0,0,0;False;14;FLOAT3;0,0,0;False;0
WireConnection;4;0;16;3
...
WireConnection;14;8;7;0
WireConnection;14;9;16;2
WireConnection;1;0;14;0
WireConnection;1;1;14;7
WireConnection;1;3;4;0
WireConnection;1;4;4;2
WireConnection;1;8;13;0
WireConnection;1;9;13;0
ASEEND*/
//CHKSM=38B818724FBC42D3969ED2B60CF099E82B9901A2