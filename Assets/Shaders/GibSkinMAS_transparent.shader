...
Shader "SLZ/GibSkinMAS Transparent"
{
	Properties
	{
		...
		[HDR]_BloodyEmission("Bloody Emission", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform float4 _BloodyEmission;
			...
			fixed4 frag (v2f i , bool bIsFrontFace : SV_IsFrontFace) : SV_Target
			{
				...
				float4 tex2DNode64 = tex2D( _MainTex, uv_MainTex64 );
				...
				float4 lerpResult57 = lerp( lerpResult130 , ( tex2DNode64 * _Color * float4( (( tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) * unity_ColorSpaceDouble )).rgb , 0.0 ) ) , temp_output_227_0);
				...
				float clampResult322 = clamp( ( tex2DNode64.a * _Color.a * temp_output_227_0 ) , 0.0 , 1.0 );
			...
			//	float3 vNormalTs = float3( 0.0, 0.0, 1.0 );		
				...
				float3 Emission = ( _BloodyEmission * ( 1.0 - Hits166 ) ).rgb;
...
/*ASEBEGIN
Version=16900
-25;547;1263;1044;-2035.313;299.7151;2.375062;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;89;225.1385,-2208.598;Float;False;Property;_BloodyTexScale;Bloody Tex Scaling;6;0;Create;False;0;0;False;0;1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;72;1053.942,-2491.567;Float;True;Property;_BloodyTex;BloodyTex;4;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Bloody Properties);None;f152c473e6ec9354f9acf7e89d54b66b;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.SamplerNode;310;1726.111,511.4778;Float;True;Property;_DetailAlbedoMap;Detail Albedo Map;16;0;Create;True;0;0;False;0;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;47;1643.43,-1761.654;Float;False;Property;_BloodyColor;BloodyColor;5;0;Create;True;0;0;False;0;1,1,1,0.5607843;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;133;1722.14,31.82836;Float;True;Property;_MetallicGlossMap;MAS Metallic;3;1;[NoScaleOffset];Create;False;0;0;False;0;None;51d26bb75517ef647989b4020647ba4e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;80;1740.551,258.6185;Float;True;Property;_BumpMap;Normal;2;1;[NoScaleOffset];Create;False;0;0;False;0;None;8cb09347ca8738042b77dabbd78546fa;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SwizzleNode;320;2478.474,288.8658;Float;False;FLOAT3;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;296;3563.611,336.5869;Float;False;166;Hits;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;64;1718.231,-173.648;Float;True;Property;_MainTex;Main Texture;0;1;[NoScaleOffset];Create;False;0;0;False;0;None;983b464bc60307d4b990fb89959c4825;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;263;2051.843,-170.4326;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;321;3424.607,153.8899;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;324;3960.612,312.2481;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;323;3844.31,-230.5002;Float;False;Property;_BloodyEmission;Bloody Emission;19;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1024,216.8471,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;304;4134.759,851.6693;Float;False;Property;_Absorbance;Absorbance;15;0;Create;True;0;0;False;0;0.469,0.636,0.832,1;0.09999988,0.2499999,0.5,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;297;3878.325,126.4551;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;325;4122.606,-144.6574;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;322;3618.626,169.6381;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;281;4312.964,-4.677668;Float;False;True;2;Float;ASEMaterialInspector;0;11;SLZ/GibSkinMAS Transparent;1f6ac94e27bd0934ab97faa6217ad58e;True;VRBase;0;0;VRBase;15;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;False;0;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;True;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;False;0;False;-1;0;False;-1;True;2;LightMode=ForwardBase;PassFlags=OnlyDirectional;True;2;0;;0;0;Standard;0;0;1;True;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT3;0,0,0;False;13;FLOAT4;0,0,0,0;False;14;FLOAT3;0,0,0;False;0
...
WireConnection;263;2;320;0
WireConnection;314;0;80;0
WireConnection;314;1;311;0
WireConnection;321;0;64;4
WireConnection;321;1;264;4
WireConnection;321;2;227;0
